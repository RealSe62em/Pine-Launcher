...
The only supported Windows installer is the native NSIS build produced by `npm run build:installer` under `dist-native/`. Do not publish or run files from this directory.
