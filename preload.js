...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  claimOnboarding: () => ipcRenderer.invoke('claim-onboarding'),
  finishOnboarding: (status) => ipcRenderer.invoke('finish-onboarding', status),
  listDownloads: () => ipcRenderer.invoke('list-downloads'),
  controlDownload: (id, action) => ipcRenderer.invoke('control-download', id, action),
  onDownloadJobs: (cb) => { const listener = (_, jobs) => cb(jobs); ipcRenderer.on('download-jobs', listener); return () => ipcRenderer.removeListener('download-jobs', listener); },
  getInstanceHealth: (name) => ipcRenderer.invoke('get-instance-health', name),
  getSupportReport: (name, log) => ipcRenderer.invoke('get-support-report', name, log),
  saveSupportReport: (report) => ipcRenderer.invoke('save-support-report', report),
  ...
  getSkinLibrary: () => ipcRenderer.invoke('get-skin-library'),
  getMinecraftUiTextures: () => ipcRenderer.invoke('get-minecraft-ui-textures'),
  importSkin: (variant, apply) => ipcRenderer.invoke('import-skin', variant, apply),
  ...
  getInstanceScreenshots: (instanceName) => ipcRenderer.invoke('get-instance-screenshots', instanceName),
  deleteInstanceScreenshot: (instanceName, filename) => ipcRenderer.invoke('delete-instance-screenshot', instanceName, filename),
  exportInstanceScreenshots: (instanceName, filenames) => ipcRenderer.invoke('export-instance-screenshots', instanceName, filenames),
  getGameOptions: (instanceName) => ipcRenderer.invoke('get-game-options', instanceName),
  saveGameOptions: (instanceName, rows) => ipcRenderer.invoke('save-game-options', instanceName, rows),
  syncInstanceData: (source, destination, selections) => ipcRenderer.invoke('sync-instance-data', source, destination, selections),
  ...
  checkInstancePreset: (preset, gameVersion) => ipcRenderer.invoke('check-instance-preset', preset, gameVersion),
  getPendingContent: (instanceName) => ipcRenderer.invoke('get-pending-content', instanceName),
  discardContentInstall: (instanceName, id) => ipcRenderer.invoke('discard-content-install', instanceName, id),
  ...
  setProjectFrozen: (instanceName, projectId, frozen) => ipcRenderer.invoke('set-project-frozen', instanceName, projectId, frozen),
